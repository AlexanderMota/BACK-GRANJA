...
export default ({ TareasController, CommentsController }) => {
  ...
  router.get('/comentarios/:idTarea', authMiddleware, (req, res) => CommentsController.getCommentsByIdTarea(req, res));

  router.post('/', authMiddleware, (req, res) => TareasController.createTarea(req, res));
  router.post('/comentarios/:idTarea', authMiddleware, (req, res) => CommentsController.createComment(req, res));
